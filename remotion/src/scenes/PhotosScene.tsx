...
export const PhotosScene: React.FC = () => {
  ...
  const cursorPositions = [
    { x: 700, y: 200, frame: 0 },
    { x: 600, y: 300, frame: 25 },
    { x: 750, y: 450, frame: 55 },
  ];
  ...
  return (
    ...
    >
      ...
      >
        <WindowFrame>
          <Img
            src={staticFile("images/screenshot-photos.png")}
      ...
      <FeatureBadge
        text="Alle Fotos nach Körperstelle organisiert"
        delay={20}
        icon="📸"
      />
    </AbsoluteFill>
