...
/** Returns neighboring zones for a given zone name (for dropdown suggestions) */
export function getNeighborZones(zone: string): string[] {
  const neighbors: Record<string, string[]> = {
    "Stirn": ["Linke Augenbraue", "Rechte Augenbraue", "Hinterkopf"],
    "Linke Augenbraue": ["Stirn", "Linke Augenregion", "Linkes Ohr"],
    "Rechte Augenbraue": ["Stirn", "Rechte Augenregion", "Rechtes Ohr"],
    "Linke Augenregion": ["Linke Augenbraue", "Linke Wange", "Nasenwurzel", "Linkes Ohr"],
    "Rechte Augenregion": ["Rechte Augenbraue", "Rechte Wange", "Nasenwurzel", "Rechtes Ohr"],
    "Nasenwurzel": ["Linke Augenregion", "Rechte Augenregion", "Nase"],
    "Nase": ["Nasenwurzel", "Linke Wange", "Rechte Wange", "Mund"],
    "Linke Wange": ["Linke Augenregion", "Nase", "Mund", "Linkes Ohr"],
    "Rechte Wange": ["Rechte Augenregion", "Nase", "Mund", "Rechtes Ohr"],
    "Mund": ["Nase", "Linke Wange", "Rechte Wange", "Kinn"],
    "Kinn": ["Mund", "Hals"],
    "Linkes Ohr": ["Linke Wange", "Linke Augenregion", "Hinterkopf"],
    "Rechtes Ohr": ["Rechte Wange", "Rechte Augenregion", "Hinterkopf"],
    "Hinterkopf": ["Stirn", "Hinterkopf (unterer)", "Linkes Ohr", "Rechtes Ohr"],
    "Hinterkopf (unterer)": ["Hinterkopf", "Nacken"],
    "Hals": ["Kinn", "Obere Brust", "Linke Schulter", "Rechte Schulter"],
    "Nacken": ["Hinterkopf (unterer)", "Oberer Rücken", "Linke Schulter (dorsal)", "Rechte Schulter (dorsal)"],
    "Linke Schulter": ["Hals", "Obere Brust", "Linker Oberarm"],
    "Rechte Schulter": ["Hals", "Obere Brust", "Rechter Oberarm"],
    "Linke Schulter (dorsal)": ["Nacken", "Oberer Rücken", "Linker Oberarm"],
    "Rechte Schulter (dorsal)": ["Nacken", "Oberer Rücken", "Rechter Oberarm"],
    "Obere Brust": ["Hals", "Brust", "Linke Schulter", "Rechte Schulter"],
    "Brust": ["Obere Brust", "Bauch"],
    "Oberer Rücken": ["Nacken", "Mittlerer Rücken", "Linke Schulter (dorsal)", "Rechte Schulter (dorsal)"],
    "Bauch": ["Brust", "Unterbauch", "Linke Hüfte", "Rechte Hüfte"],
    "Mittlerer Rücken": ["Oberer Rücken", "Unterer Rücken"],
    "Unterer Rücken": ["Mittlerer Rücken", "Gesäß", "Linke Gesäßhälfte", "Rechte Gesäßhälfte"],
    "Unterbauch": ["Bauch", "Linke Hüfte", "Rechte Hüfte"],
    "Linke Hüfte": ["Bauch", "Unterbauch", "Linker Oberschenkel"],
    "Rechte Hüfte": ["Bauch", "Unterbauch", "Rechter Oberschenkel"],
    "Gesäß": ["Unterer Rücken", "Linke Gesäßhälfte", "Rechte Gesäßhälfte"],
    "Linke Gesäßhälfte": ["Gesäß", "Unterer Rücken", "Linker Oberschenkel (dorsal)"],
    "Rechte Gesäßhälfte": ["Gesäß", "Unterer Rücken", "Rechter Oberschenkel (dorsal)"],
    "Linker Oberarm": ["Linke Schulter", "Linker Unterarm"],
    "Rechter Oberarm": ["Rechte Schulter", "Rechter Unterarm"],
    "Linker Unterarm": ["Linker Oberarm", "Linke Hand"],
    "Rechter Unterarm": ["Rechter Oberarm", "Rechte Hand"],
    "Linke Hand": ["Linker Unterarm"],
    "Rechte Hand": ["Rechter Unterarm"],
    "Linker Oberschenkel": ["Linke Hüfte", "Linker Oberschenkel (distal)", "Linkes Knie"],
    "Rechter Oberschenkel": ["Rechte Hüfte", "Rechter Oberschenkel (distal)", "Rechtes Knie"],
    "Linker Oberschenkel (distal)": ["Linker Oberschenkel", "Linkes Knie"],
    "Rechter Oberschenkel (distal)": ["Rechter Oberschenkel", "Rechtes Knie"],
    "Linker Oberschenkel (dorsal)": ["Linke Gesäßhälfte", "Linke Kniekehle"],
    "Rechter Oberschenkel (dorsal)": ["Rechte Gesäßhälfte", "Rechte Kniekehle"],
    "Linkes Knie": ["Linker Oberschenkel", "Linker Unterschenkel"],
    "Rechtes Knie": ["Rechter Oberschenkel", "Rechter Unterschenkel"],
    "Linke Kniekehle": ["Linker Oberschenkel (dorsal)", "Linke Wade"],
    "Rechte Kniekehle": ["Rechter Oberschenkel (dorsal)", "Rechte Wade"],
    "Linker Unterschenkel": ["Linkes Knie", "Linker Fuß"],
    "Rechter Unterschenkel": ["Rechtes Knie", "Rechter Fuß"],
    "Linke Wade": ["Linke Kniekehle", "Linke Ferse"],
    "Rechte Wade": ["Rechte Kniekehle", "Rechte Ferse"],
    "Linker Fuß": ["Linker Unterschenkel"],
    "Rechter Fuß": ["Rechter Unterschenkel"],
    "Linke Ferse": ["Linke Wade"],
    "Rechte Ferse": ["Rechte Wade"],
  };
