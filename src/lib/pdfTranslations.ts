...
const de: PdfTexts = {
  ...
  section6Support: "Support erfolgt über das integrierte Ticket-System mit Echtzeit-Chat sowie per E-Mail an info@techassist.ch.",
...
const en: PdfTexts = {
  ...
  section6Support: "Support is provided via the integrated ticket system with real-time chat and by email at info@techassist.ch.",
...
const fr: PdfTexts = {
  ...
  section6Support: "Le support est assuré via le système de tickets intégré avec chat en temps réel et par e-mail à info@techassist.ch.",
...
const it: PdfTexts = {
  ...
  section6Support: "Il supporto è fornito tramite il sistema di ticket integrato con chat in tempo reale e via e-mail all'indirizzo info@techassist.ch.",
...
const es: PdfTexts = {
  ...
  section6Support: "El soporte se proporciona a través del sistema de tickets integrado con chat en tiempo real y por correo electrónico a info@techassist.ch.",
